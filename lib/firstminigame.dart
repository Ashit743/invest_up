...
class FirstMiniGame extends StatelessWidget {
  @override
...
class _HomePageState extends State<HomePage> {
  ...
  void updateDamage() {
    setState(() {
      if (spaceship.isEmpty || alien.isEmpty) {
        _showGameOverScreen();
      } else {
  ...
  void alienMissile() {
    if (spaceship.isEmpty || alien.isEmpty) {
      ...
      const durationMissile = const Duration(milliseconds: 150);
      Timer.periodic(
        durationMissile,
        (Timer timer) {
          updateAlienMissile();
